...
Signavio.Config.BACKEND_PATH = "/apertemodeler/p";
...
Signavio.Config.LOGIN_PAGE = "/apertemodeler/p/login";
Signavio.Config.RESET_PASSWORD_PAGE = "/p/resetPassword";
Signavio.Config.VALIDATE_ORDER_PATH = "/p/validate_order";
Signavio.Config.MIGRATION_PATH = "/apertemodeler/p/migration";
...
new function () {
	...
	var e = {};
	e.PATTERN = new RegExp("(" + Signavio.Config.BACKEND_PATH + "/apertemodeler/p/)?([^/]+)(/([^/]+))?(/([^/]+))?(/+(.*))?$");
	e.split = function (g) {
		if (!g || !(g.startsWith("/"))) {
